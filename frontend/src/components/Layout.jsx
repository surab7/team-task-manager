      ...
      <aside className="w-60 bg-ink-900 border-r border-ink-700 flex flex-col fixed top-0 left-0 h-full z-10">
        ...
        <div className="px-6 py-5 border-b border-ink-700">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display font-700 text-lg tracking-tight text-white">TaskFlow</span>
          </div>
        </div>
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                  isActive
                    ...
                    : 'text-white/50 hover:text-white hover:bg-ink-700'
                }`
              }
            >
              {item.icon}
        ...
        <div className="px-3 pb-4 border-t border-ink-700 pt-4">
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg">
            ...
            <button onClick={handleLogout} className="text-white/30 hover:text-rose transition-colors" title="Logout">
